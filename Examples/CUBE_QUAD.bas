...
iPositionEntity( Cube, 0, 0, 20 )
iEntityColor( Cube, 0, 255, 0 )

dim Quad as iENTITY = iCreateQuad()
iPositionEntity( Quad, 0, 0, 30 )
iRotateEntity( Quad, -90, 0, 0 )
iEntityColor( Quad, 255, 0, 0 )

dim z as single = 20
dim dx as single = -0.1
