## ----------------------------------------------------------------------------
## 					RAKNET VARIABLES AND CONSTANTS
## ----------------------------------------------------------------------------
#	USER MESSAGE TYPES	134 To 255
...
#MESSAGE PRIORITIES
IMMEDIATE_PRIORITY = 0		    #Not BUFFERED - SENDS IMMEDIATELY
HIGH_PRIORITY = 1				#BUFFERED - SEND IN GROUPS EVERY 10ms
MEDIUM_PRIORITY = 2			    #*
LOW_PRIORITY = 3				#*
...
ID_RESERVED_8 = 132
ID_RESERVED_9 = 133
#	USER MESSAGES CAN START AT 134
